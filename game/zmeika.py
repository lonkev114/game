...
back1 = pygame.image.load("silach.png")
back1 = pygame.transform.scale(back1, (WIDTH, HEIGHT))
sila = pygame.image.load("dota4.jpg")
sila = pygame.transform.scale(sila, (WIDTH, HEIGHT))
back = pygame.image.load("back.png")
back = pygame.transform.scale(back, (WIDTH, HEIGHT))
music_files = ["Дон Омар feat Tego Calderon - Los Bandoleros.mp3", "skrillex-damian-jr_-gong-marley-make-it-bun-dem.mp3", "betsy-marija-jankovskaja-sigma-bojj.mp3"]
...
def load_sprites(cell_size):
    head = pygame.image.load("jeskiflow.jfif")
    body = pygame.image.load("vodichka.jfif")
    apple = pygame.image.load("bounty.png")
